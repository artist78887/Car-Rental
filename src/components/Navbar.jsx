...
const Navbar = ({ setShowLogin }) => {
  ...
  return (
    <div
      className={`flex items-centre justify-between px-6 md:px-16 lg:px-24 x1:px-32 py-4 text-gry-600 border-b border-borderColor relative transition-all ${
    ...
    >
      ...
      >
        ...
        <div className="flex max-sm:flex-col items-start sm-items-centre gap-6">
          <button
